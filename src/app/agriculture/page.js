      ...
      <div className="flex gap-8">
        ...
        <aside className="hidden lg:block w-72 shrink-0 space-y-6">
          ...
          <div className="bg-white rounded-2xl border border-slate-100 p-5">
            ...
            <ul className="space-y-2 text-sm text-slate-600">
              {["ICAR-IISR Lucknow", "NFCSF", "DSCRI Coimbatore", "VSICL Pune", "UPCSR Shahjahanpur"].map((b) => (
                <li key={b} className="hover:text-green-600 cursor-pointer transition-colors flex items-center gap-2">
          ...
          <div className="bg-green-50 border border-green-100 rounded-2xl p-5">
            ...
            <button className="w-full bg-green-500 text-white text-sm font-semibold py-2 rounded-lg hover:bg-green-600 transition-colors">Learn More</button>
          </div>
        </aside>
      </div>
    </div>
