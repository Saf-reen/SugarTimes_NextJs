...
export default function PricingCard({ plan }) {
  return (
    <div className={`relative rounded-2xl border-2 p-6 flex flex-col ${plan.popular ? "border-amber-500 shadow-xl shadow-amber-100" : "border-slate-200 bg-white"}`}>
      {plan.popular && (
      ...
      <div className={`w-10 h-10 rounded-xl flex items-center justify-center mb-4 ${plan.popular ? "bg-amber-500" : "bg-slate-100"}`}>
